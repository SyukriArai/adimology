...
const APP_API_URL = "https://glittery-belekoy-b55b69.netlify.app/api/update-token"; // Prod
...
chrome.webRequest.onBeforeSendHeaders.addListener(
    ...
    if (authHeader && authHeader.value) {
      ...
      if (authHeader.value.startsWith("Bearer ")) {
        ...
        if (token !== lastSyncedToken) {
          console.log("New token detected. Analyzing...");
          
          const decoded = parseJwt(token);
          const expiresAt = decoded ? decoded.exp : null;
          
          // Debugging
          console.log("Token Expiry:", expiresAt ? new Date(expiresAt * 1000) : "Unknown");
  ...
  { urls: ["https://stockbit.com/*", "https://api.stockbit.com/*"] },
  ["requestHeaders"]
);
